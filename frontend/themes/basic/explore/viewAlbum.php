...
$this->params['breadcrumb'][] = ['label' => Yii::t('app', 'Opuses'), 'url' => ['/explore/opuses']];
    ...
    <?php else: ?>
        ...
        <div class="img-all row">
            ...
            <?php foreach ($model->opuses['opuses'] as $opus): ?>
                <?php
                    $albumUrl = Url::toRoute(['/explore/view-album', 'id' => $opus['id']]);
                    $src = (empty($opus['path'])) ? Yii::getAlias('@web/images/pic-none.png') : $opus['path'] ;
                ?>
                <div class="col-xs-6 col-sm-4 col-md-3">
                    <div class="photo-item">
                        <a title="<?= Html::encode($opus['name']) ?>" href="<?= $src ?>" data-lightbox="image-1" data-title="<?= Html::encode($model['name']) ?>">
